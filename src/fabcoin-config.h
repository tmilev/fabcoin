/* src/config/fabcoin-config.h.  Generated from fabcoin-config.h.in by configure.  */
/* src/config/fabcoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Fabcoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Fabcoin Core"

/* Copyright year */
#define COPYRIGHT_YEAR 2018

/* Define to 1 to enable gpu miner */
/* #undef ENABLE_GPU */
...
#define PACKAGE_BUGREPORT "https://github.com/blockchaingate/fabcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Fabcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Fabcoin Core 0.15.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "fabcoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "http://fabcoin.pro/"
