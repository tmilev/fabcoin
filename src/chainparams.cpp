...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlockTestnet(
            ...
            0x2007ffff, 1, 25 * COIN );
        consensus.hashGenesisBlock = genesis.GetHash(consensus);
        logBeforeInitialization() << "DEBUG: The hash of the genesis block is: " << consensus.hashGenesisBlock.GetHex() << LoggerSession::endL;
        logBeforeInitialization() << "DEBUG: The hash of the merkle root is: " << genesis.hashMerkleRoot.GetHex() << LoggerSession::endL;
